...
using SistemaAcademico.WebApp.Controllers;
using viewModels = SistemaAcademico.WebApp.Areas.SecurityGuard.ViewModels;

namespace SistemaAcademico.WebApp.Areas.SecurityGuard.Controllers
{
